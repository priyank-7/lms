...
public class QuizResultController {
    ...
    public ResponseEntity<QuizResultDTO> getQuizResult(@PathVariable("quizResult_id") String quizResult_id) {
        return ResponseEntity.ok(this.quizResultService.getQuizResult(quizResult_id));
    }

    @GetMapping("/{student_id}/getByStudent")
    public ResponseEntity<List<QuizResultDTO>> getQuizResultByStudent(@PathVariable("student_id") String student_id) {
    ...
    public ResponseEntity<QuizResultDTO> getQuizResultByStudentAndQuiz(@PathVariable("student_id")String student_id, @PathVariable("quiz_id") String quiz_id) {
        return ResponseEntity.ok(this.quizResultService.getQuizResultByQuizAndStudent(student_id, quiz_id));
    }

    @GetMapping("/{quiz_id}/getByQuiz")
    public ResponseEntity<List<QuizResultDTO>> getQuizResultByQuiz(@PathVariable("quiz_id") String quiz_id) {
        return ResponseEntity.ok(this.quizResultService.getQuizResultByQuiz(quiz_id));
    }
}
